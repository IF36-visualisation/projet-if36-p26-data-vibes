...
- La forme de la courbe révèle la concentration réelle des matchs
  (bimodalité, queues longues) là où le boxplot ne synthétise que cinq quantiles.
- Les vagues superposées rendent les décalages entre groupes immédiatement perceptibles, sans nécessiter de lecture des médianes chiffrées donc améliore la lisibilité.
...
### Analyse des résultats
- Les `A` situés **sous** la diagonale (domicile tire plus mais perd) = hold-ups subis.
- Les `H` situés **au-dessus** de la diagonale (extérieur tire plus mais perd) = hold-ups réalisés.
