...
Ce résultat suggère l’existence d’un avantage du terrain en Premier League : jouer à domicile semble augmenter les chances de victoire.

### Interprétation et limites

Cette analyse met en évidence une tendance générale en faveur des équipes à domicile. Elle confirme donc l’hypothèse de départ.

Cependant, elle ne permet pas d’expliquer précisément les causes de cet avantage. D’autres facteurs, comme le niveau des équipes, la saison, la forme du moment ou l’adversaire rencontré, peuvent aussi influencer les résultats.
...
## 6. Quelle proportion de matchs connaît un retournement ?
...
## 8. La différence de tirs entre les deux équipes est-elle associée au résultat final ?

### Hypothèse

Nous supposons que la différence de tirs entre les deux équipes est liée au résultat final du match. Plus une équipe tire davantage que son adversaire, plus elle devrait avoir de chances de gagner. Cependant, cette relation n’est pas forcément automatique, car le nombre de tirs ne prend pas en compte la qualité des occasions.
...
## 9. Les tirs cadrés permettent-ils de mieux expliquer le nombre de buts que le nombre total de tirs ?
...
## 13. Les matchs les plus ouverts offensivement sont-ils aussi les plus imprévisibles ?
...
Lorsque le nombre total de buts augmente, l’écart au score peut aussi augmenter. Cela montre que les matchs les plus ouverts ne sont pas toujours les plus imprévisibles : certains sont spectaculaires mais restent déséquilibrés.
...
## 14. Comment l'efficacité (Buts/Tirs) varie-t-elle selon les 5 meilleures équipes ?
...
## 17. Les arbitres sanctionnent-ils de la même manière un nombre donné de fautes ?
...
## 18. Certaines équipes sont-elles plus sanctionnées que d'autres ?
...
## 20.Le nombre de buts évolue-t-il selon les saisons ?
